...
//++CK
                ...
                if (ClassDefaultObject)
                {
                    ...
                    {
                        const uint8* StructData = Property->ContainerPtrToValuePtr<uint8>(ClassDefaultObject);
                        if (StructData)
                        {
...
//++CK
    CustomizeProxyFactoryFunction(CompilerContext, SourceGraph, CreateProxyObject_Node);
//--CK
